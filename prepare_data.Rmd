...
c3.evaluations$documentevaluation_start <- strptime(c3.evaluations$documentevaluation_start, "%Y-%m-%d %H:%M:%OS")
c3.evaluations$documentevaluation_end <- strptime(c3.evaluations$documentevaluation_end, "%Y-%m-%d %H:%M:%OS")
...
show_miliseconds <- options(digits.secs=6)
c3.labelings$start <- strptime(c3.labelings$start, "%Y-%m-%d %H:%M:%OS")
c3.labelings$end <- strptime(c3.labelings$end, "%Y-%m-%d %H:%M:%OS")
